...
// export default function Chart({data}) {
//   // Check if data is empty or undefined before accessing its elements
//   if (!data || data.length === 0) {
//     // Handle the case when data is empty or undefined, e.g., return a placeholder or null
//     return <div>No data available.</div>;
//   }

//   // Find the key other than 'date' in the first object of the data array
//   const xLabelKey = Object.keys(data[0]).find(key => key !== 'date');
    ...
    <div>
      <ResponsiveContainer width="100%" height={200}>
        <LineChart width={730} height={250} data={dataWithoutGaps}
          ...
          <Tooltip />
          <Line
             type="monotone" dataKey={xLabelKey} stroke="#09f" strokeWidth="6" />
